...
//         destination={props.trip.vacation.vacationlocation}
    ...
    <div>
      <Link to={`/trip-form-update/${props.trip.vacation.vacationid}`}>
        <StyledIcon className="edit-btn">Edit Trip</StyledIcon>
      </Link>
      <StyledIcon onClick={deleteTrip}>Delete Trip</StyledIcon>
      <Link to={`/trip-chat/${props.trip.vacation.vacationid}`}>
        <StyledIcon className="edit-btn">Trip Chat</StyledIcon>
      </Link>
    </div>
    </StyledDiv>
  );
